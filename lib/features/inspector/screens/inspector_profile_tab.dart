...
class _InspectorProfileTabState extends State<InspectorProfileTab> {
  ...
  // 🎨 Unified Theme Colors (Inspector Purple)
  final Color _themeColor = const Color(0xFF512DA8); // Deep Purple
  final Color _lightColor = const Color(0xFF7E57C2); // Light Purple
  ...
  Future<void> _fetchProfileData() async {
    if (_name == "Inspector") setState(() => _isLoading = true);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // 1. DIGITAL ID CARD
                _buildDigitalIdCard(memberId, "OFF", "I", "Official Status"),
                const SizedBox(height: 24),
                ...
                _buildMenuGroup([
                  _buildMenuItem(
                    ...
                    subtitle: "Update your profile & official documents",
                    onTap: () async {
                      if (_profile != null) {
                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => InspectorEditProfileScreen(
                                    profile: _profile!)));
                ...
                // 3. OPERATIONS GROUP (Inspector Specific)
                _buildSectionTitle("Operations"),
                _buildMenuGroup([
                  _buildMenuItem(
                    icon: Icons.people_outline,
                    title: "Mapped Farmers",
                    subtitle: "View farmers assigned to your district",
                  ...
                  _buildMenuItem(
                    ...
                    subtitle: "Review past inspected orders",
                    iconColor: Colors.brown.shade600,
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) =>
                                const InspectorOrdersTab(initialIndex: 2))),
                  ),
                ]),
                const SizedBox(height: 24),
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) => SettingsScreen(
                                themeColor: _themeColor, role: 'inspector'))),
                  ),
                ]),
                const SizedBox(height: 24),

                // 🚀 6. APP INFO & RATING SECTION
